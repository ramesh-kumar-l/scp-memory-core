...
| R3 | **Trust mis-calibration** — confidence misleads consumers | M | H | Calibration benchmarks; explainability so users can judge; trust as signal not truth ([15](15-trust-model.md)) |
